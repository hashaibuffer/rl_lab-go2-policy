...
def main():
    ...
    if args_cli.use_pretrained_checkpoint:
        if get_published_pretrained_checkpoint is None:
            print("[INFO] Pre-trained checkpoint lookup is unavailable in this IsaacLab version.")
            return
    ...
    if hasattr(runner, "export_policy_to_jit") and hasattr(runner, "export_policy_to_onnx"):
        ...
        if hasattr(runner.alg, "policy"):
            ...
            raise AttributeError("Unable to locate policy network on the RSL-RL runner.")
